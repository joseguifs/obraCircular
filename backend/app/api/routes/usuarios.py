...
async def obter_usuario(usuario_id: UUID, servico: ServicoDep) -> UsuarioRead:
...
async def atualizar_usuario(
    usuario_id: UUID, dados: UsuarioUpdate, servico: ServicoDep
) -> UsuarioRead:
...
async def excluir_usuario(usuario_id: UUID, servico: ServicoDep) -> None:
